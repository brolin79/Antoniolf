...
<head>
    ...
    <meta name="keywords" content="Portfolio, Programming, Web Design, IT" />
...
<div class="wrapper">	
	...
	<div class="grids">
      ...
      <br>
      <div class="social">
	    <a href="index.php" title="spanish"><img src="img/icons/spain.png" width="50" height="39" alt="Spanish"></a>&nbsp;
        <a href="indexen.php" title="english"><img src="img/icons/english.png" width="50" height="39" alt="English"></a>&nbsp;
      </div>
      ...
      <div class="grid-16 grid">        
		...
		<div id='cssmenu'>
		<ul>
		   <li <? if ($toi=="indexen.php"){echo"class='active'";}?>><a href='indexen.php'><img src="img/menu/home.png"/>&nbsp;<span>Home</span></a></li>
		   <li <? if ($toi=="portfolio.php"){echo"class='active'";}?>><a href='portfolio.php'><img src="img/menu/portafolio.png"/>&nbsp;<span>Portfolio</span></a></li>
		   <li <? if ($toi=="downloads.php"){echo"class='active'";}?>><a href='downloads.php'><img src="img/menu/descargas.png"/>&nbsp;<span>Downloads</span></a></li>
		   <li class='has-sub'><a href='#'><img src="img/menu/miscelanea.png"/>&nbsp;<span>Miscelanea&nbsp;&nbsp;&nbsp;&nbsp;</span></a>
			  <ul>
				   <li><a href='translations.php'><img src="img/menu/tradu.png"/>&nbsp;<span>Translations</span></a></li>
				   <li><a href='shirts.php'><img src="img/menu/shirt.png"/>&nbsp;<span>Shirts</span></a></li>
				   <li ><a href='http://www.antoniolf.es/alineapp' target="_blank"><img src="img/menu/alineapp.png"/>&nbsp;<span>Alineapp</span></a></li>
			  </ul>
		   </li>
		   <li <? if ($toi=="contact.php"){echo"class='active'";}?>><a href='contact.php'><img src="img/menu/contacto.png"/>&nbsp;<span>Contact</span></a></li>
		</ul>
		</div><!--#cssmenu-->
